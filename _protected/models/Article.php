...
class Article extends ActiveRecord
{
    ...
    const CATEGORY_COMMON = 1;
    const CATEGORY_NEWS = 2;
    const CATEGORY_NOTICE = 3;
    ...
    public function getCategoryName($category = null)
    {
        ...
        if ($category === self::CATEGORY_NOTICE)
        {
            return Yii::t('app', 'Notice');
        }
        elseif ($category === self::CATEGORY_NEWS)
        {
            return Yii::t('app', 'News');
        }
        else
        {
            return Yii::t('app', 'Common');
        }
    }
    ...
    {
        $statusArray = [
            self::CATEGORY_COMMON => Yii::t('app', 'Common'),
            self::CATEGORY_NEWS => Yii::t('app', 'News'),
            self::CATEGORY_NOTICE   => Yii::t('app', 'Notice'),
        ];
